...
export function PricingBlock() {
  const plans = [
    ["Старт", "от 45 878 ₽", "Небольшая автоматизация, форма, таблица, уведомления или технический фикс."],
    ["Бизнес", "от 107 050 ₽", "Сайт, бот, интеграция, контроль заявок или связка из нескольких сервисов."],
