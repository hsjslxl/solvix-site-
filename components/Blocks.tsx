    ...
    <section className="hero">
      <div className="shell hero-grid">
        <Reveal className="hero-copy">
          <p className="eyebrow">Solvix / автоматизация заявок</p>
          <h1>Помогаем бизнесу не терять заявки и время на ручную работу</h1>
          <p className="hero-text">
            Связываем сайт, Telegram, таблицы и простую CRM в одну понятную систему.
            Заявки сразу доходят до ответственного, а владелец видит их статус.
          </p>
...
export function PricingBlock() {
  const plans = [
    ["Старт", "примерно от 7 500 ₽", "Небольшая автоматизация, форма, таблица, уведомления или технический фикс."],
    ["Бизнес", "примерно от 22 000 ₽", "Сайт, бот, интеграция, контроль заявок или связка из нескольких сервисов."],
  ...
  return (
    <section className="section">
      <div className="shell">
        <SectionHeading
          eyebrow="Стоимость"
          title="Показываем понятный ориентир до обсуждения деталей"
          text="Точная стоимость зависит от объёма и интеграций, но обычно остаётся близкой к выбранному формату из каталога."
        />
        <MobileCollapsible>
