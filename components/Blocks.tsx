...
export function PricingBlock() {
  const plans = [
    ["Старт", "от 22 939 ₽", "Небольшая автоматизация, форма, таблица, уведомления или технический фикс."],
    ["Бизнес", "от 53 525 ₽", "Сайт, бот, интеграция, контроль заявок или связка из нескольких сервисов."],
